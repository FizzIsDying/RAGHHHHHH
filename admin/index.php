...
<html lang="en">
    ...
    <button type="button" class="btn w-md btn-bordered btn-danger waves-effect waves-light pull-left" onclick="goBack()">Go Back</button>
</div>
                                        <div class="form-group account-btn text-center m-t-10">
                                            <div class="col-xs-12">
                                                <button class="btn w-md btn-bordered btn-danger waves-effect waves-light pull-right" type="submit" name="login">Log In</button>
                                            </div>
                                        </div>
